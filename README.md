...
1. **How does language support affect user reception and player engagement?(who feels included?) If popular games or the majority of the games include only 2 to 3 langauges, does this limit global participation?**
2. **What is the effect of price and violence content on these outcomes?(who gets to play?)**
...
As affordable games are more financially accessible and multilingual games reach more players across language barriers. 
